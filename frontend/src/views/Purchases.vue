<template>
  <div class="page">
    ...
    <el-table :data="orders" stripe style="width: 100%" size="large">
    ...
    <!-- New Purchase Dialog -->
    <el-dialog v-model="dialogVisible" title="新增采购单" width="650px" destroy-on-close>
...
import {
  ...
  getSuppliers, getMaterials, canEdit,
} from '../api'
